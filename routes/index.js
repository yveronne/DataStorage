...
module.exports = (app) => {
    ...
    app.get("/api/stations/:ipAdress",validator.validate('retrieveStation'),stationsController.retrieve);
    //app.get("/api/stations/:name",validator.validate('retrieveStationByName'),stationsController.retrieveByName);
    app.put('/api/stations/:stationId',validator.validate('deleteStation'), stationsController.update); //update informations on a station
    //app.put('/api/stations/:ipAdress', validator.validate('retrieveStation'), stationsController.update);
    //app.delete('/api/stations/:stationId', validator.validate('retrieveStation'),stationsController.destroy); //delete a station
    app.delete('/api/stations/:stationId', validator.validate('deleteStation'),stationsController.destroy); 
